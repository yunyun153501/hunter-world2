...
**장비**: 협회지급 투척단검, E급 조악한 예비단검, E급 투박한 기동조끼

**스킬**:

| 스킬명 | 분류 | 카테고리 | 등급 | 성장형 | 설명 |
|--------|------|----------|------|:------:|------|
| 정밀조준 | 포지션스킬 | 패시브 | Rare | ✅ | 등급별 치명타 확률 상승 |
| 나이프회수 | 직업스킬 | 단일공격 | Rare | ✅ | 투척 후 나이프 회수하며 공격 |
| 단검숙련 | 범용스킬 | 패시브 | Normal | — | 단검 착용 시 SP 소모량 -10% |
...
**장비**: 협회지급 검, D급 평범한 방패, D급 실용적인 판금갑옷
...
| 홀리라이트 | 직업스킬 | 단일CC | Normal | — | D급 빛속성 마법 피해 + 실명(20%, 3턴). MP 30. |
